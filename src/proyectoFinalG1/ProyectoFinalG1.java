...
public class ProyectoFinalG1 {
    ...
    public static void main(String[] args) {
       ...
       Inquilino i = new Inquilino("ElMas", "Capo", 20454758928, "Camionero", "DiosPaga", 001, true);
       
       Contrato c = new Contrato(LocalDate.of(6, 2, 2022), LocalDate.of(15, 10, 2025), LocalDate.now(), e, Inquilino inquilino, Inmueble inmueble, boolean activo);
       ContratoData cd;*/
